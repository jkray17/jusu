  ...
  var ue = [function (e) {
    ...
    oe({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e68 = 0; _e68 < a.length; _e68 += 1) {
          var _t46 = a[_e68];
          var _s39 = _e68;
          u && (_s39 = parseInt(_t46.getAttribute("data-swiper-slide-index"), 10));
          ...
          var _d5 = Math.max(Math.min(_t46.progress, 1), -1);

          var _m3 = 0,
              _f2 = 0,
              _g = 0;
          _s39 % 4 == 0 ? (_m3 = 4 * -_n10 * o, _g = 0) : (_s39 - 1) % 4 == 0 ? (_m3 = 0, _g = 4 * -_n10 * o) : (_s39 - 2) % 4 == 0 ? (_m3 = o + 4 * _n10 * o, _g = o) : (_s39 - 3) % 4 == 0 && (_m3 = -o, _g = 3 * o + 4 * o * _n10), l && (_m3 = -_m3), p || (_f2 = _m3, _m3 = 0);

          var _v = "rotateX(".concat(p ? 0 : -_r17, "deg) rotateY(").concat(p ? _r17 : 0, "deg) translate3d(").concat(_m3, "px, ").concat(_f2, "px, ").concat(_g, "px)");

          _d5 <= 1 && _d5 > -1 && (h = 90 * _s39 + 90 * _d5, l && (h = 90 * -_s39 - 90 * _d5)), _t46.style.transform = _v, c.slideShadows && i(_t46, _d5, p);
        }
    ...
    oe({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _r18 = 0; _r18 < e.length; _r18 += 1) {
          ...
          t.isHorizontal() ? s && (_d6 = -_d6) : (_u4 = _p4, _p4 = 0, _c3 = -_d6, _d6 = 0), _n11.style.zIndex = -Math.abs(Math.round(_l8)) + e.length, a.slideShadows && i(_n11, _l8);
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e70 = 0, _t49 = a.length; _e70 < _t49; _e70 += 1) {
          var _t50 = a[_e70],
              _s41 = i[_e70],
              _l9 = (o - _t50.swiperSlideOffset - _s41 / 2) / _s41,
          ...
          if (de(0, _t50).style.transform = _b, _t50.style.zIndex = 1 - Math.abs(Math.round(_p5)), r.slideShadows) {
            var _e71 = n ? _t50.querySelector(".swiper-slide-shadow-left") : _t50.querySelector(".swiper-slide-shadow-top"),
                _s42 = n ? _t50.querySelector(".swiper-slide-shadow-right") : _t50.querySelector(".swiper-slide-shadow-bottom");

            _e71 || (_e71 = pe("coverflow", _t50, n ? "left" : "top")), _s42 || (_s42 = pe("coverflow", _t50, n ? "right" : "bottom")), _e71 && (_e71.style.opacity = _p5 > 0 ? _p5 : 0), _s42 && (_s42.style.opacity = -_p5 > 0 ? -_p5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
        ...
        var _loop2 = function _loop2(_s43) {
          ...
          if (h && f.shadow || !h) {
            ...
            if (!_e73 && f.shadow && (_e73 = pe("creative", a)), _e73) {
              ...
              _e73.style.opacity = Math.min(Math.max(Math.abs(_t51), 0), 1);
            }
          }
